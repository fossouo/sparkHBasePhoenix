...
public class readTable_phoenix {
    public static void main(String[] args){
        ...
        conf.setAppName("ECLoad").setMaster("local").set("spark.sql.warehouse.dir", warehouseLocation);
       ...
       System.out.println("Using JDBC Driver");
        ...
        DataFrame readPhoenix = sqlContext.read().format("org.apache.phoenix.spark")
        ...
        System.out.println("Here is the schema of Phoenix Table");
        readPhoenix.printSchema();
        System.out.println("Here is the body of Phoenix Table");
        readPhoenix.show();
